...
const Login: React.FC = () => {
  ...
  return (
    <div className="w-full h-screen bg-custom-bg flex flex-col items-center justify-center">
      <h1 className=" mb-5 text-center text-custom-purple">
        Demo Credentials : zaidachhwa8486@gmail.com | Zaid@1234
      </h1>
      <form
      ...
      >
        ...
        <div className="w-full flex flex-col my-5 gap-5 items-center justify-center">
          ...
          <p className="text-sm">
            ...
            <Link to="/signup" className="ml-1 underline text-custom-purple">
              Register
            </Link>
          </p>
        </div>
